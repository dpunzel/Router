...
public class Router
{
   ...
   public static void main(String[] args){
      ...
      System.out.println("--------------------------------------");
      // making the test larger
      router.parseCmd("DEL prefix=157.29.32.0/20, route=1");
      router.parseCmd("DEL prefix=157.29.48.0/21, route=2");
      router.parseCmd("DEL prefix=157.0.0.0/8, route=4");
      router.parseCmd("DEL prefix=157.29.62.0/23, route=NULL");
      router.parseCmd("DEL prefix=0/0, route=5");
      System.out.println("--------------------------------------");
      // adding same values after delete
      router.parseCmd("ADD prefix=157.29.32.0/20, route=1");
      router.parseCmd("ADD prefix=157.29.48.0/21, route=2");
      router.parseCmd("ADD prefix=157.29.48.0/20, route=3");
      router.parseCmd("ADD prefix=157.0.0.0/8, route=4");
      ...
      router.parseCmd("DEL prefix=0/0, route=5");
      System.out.println("--------------------------------------");
      // adding same values after delete      router.parseCmd("ADD prefix=157.29.32.0/20, route=1");
      router.parseCmd("ADD prefix=157.29.48.0/21, route=2");
      router.parseCmd("ADD prefix=157.29.48.0/20, route=3");
      router.parseCmd("ADD prefix=157.0.0.0/8, route=4");
      router.parseCmd("ADD prefix=157.29.62.0/23, route=NULL");
